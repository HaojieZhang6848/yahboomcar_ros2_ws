...
export ROBOT_TYPE=R2L   # R2, X1, X3, X3plus, X7,R2L
export RPLIDAR_TYPE=null  # a1, a2, a3, s1, s2, 4ROS,null
export CAMERA_TYPE=null  #astrapro, astraplus,null
case "$ROBOT_TYPE" in
X3 )
...
;;
R2L )
    echo "workspace link to R2L + ROBOT_TYPE: $ROBOT_TYPE"
    rm ~/yahboomcar_ws
    ln -s ~/ROS/R2L/yahboomcar_ws ~/yahboomcar_ws
;;
* )
...
echo -e "my_robot: \033[32m$ROBOT_TYPE\033[0m | my_lidar: \033[32m$RPLIDAR_TYPE\033[0m | my_camera: \033[32m$CAMERA_TYPE\033[0m"
echo "-----------------------"
...
source ~/software/library_ws/devel/setup.bash --extend
source ~/software/world_canvas/devel/setup.bash --extend
